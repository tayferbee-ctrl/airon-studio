...
export const RoiCalculator: React.FC<RoiCalculatorProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section className="relative py-20 px-6 bg-[#0B0A09] border-t border-[#1C1816] text-white overflow-hidden">
      {/* Glow effect */}
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {/* Calculator Card */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center rounded-3xl border border-[#2E201B] bg-[#120E0C] p-6 sm:p-10 shadow-2xl glow-terracotta-subtle">
          {/* Controls */}
          <div className="lg:col-span-6 space-y-6">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-mono text-sm sm:text-base font-bold text-[#E07A5F] bg-[#1E1511] px-3 py-1 rounded-lg border border-[#C86D51]/30">
            ...
            <div className="rounded-xl border border-[#241A15] bg-[#16110E] p-4 text-xs text-neutral-400 space-y-1.5 leading-relaxed">
          ...
          {/* Results Summary */}
          <div className="lg:col-span-6 rounded-2xl border-2 border-[#C86D51]/40 bg-[#1A120E] p-6 sm:p-8 flex flex-col justify-between shadow-xl ring-1 ring-[#E07A5F]/20">
            <div>
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#E07A5F] font-bold">
                Estimativa Conservadora de Perda
              </span>

              <div className="mt-4 pb-4 border-b border-[#2C1D16]">
              ...
              <div className="py-4 border-b border-[#2C1D16] space-y-3">
              ...
              <div className="mt-4 pt-2 flex items-center justify-between">
                <div>
                  ...
                  <span className="font-mono text-xl font-bold text-[#E07A5F]">{PRE_SALE_PRICE}</span>
                  <span className="text-[10px] text-neutral-400 ml-1">(taxa única, sem mensalidades)</span>
                </div>
            ...
            <div className="mt-6 pt-4 border-t border-[#2C1D16] space-y-2">
              <button
                type="button"
                onClick={onOpenBooking}
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-metallic-terracotta px-5 py-3.5 text-xs sm:text-sm font-bold text-white shadow-xl glow-terracotta-subtle transition-all hover:scale-101 active:scale-99 cursor-pointer"
              >
