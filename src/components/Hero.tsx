  ...
  return (
    <section className="relative overflow-hidden pt-10 pb-20 md:pt-16 md:pb-28 bg-[#080808]">
      ...
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <h1 className="font-serif text-4xl font-semibold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl leading-[1.12]">
        ...
        {/* Exact Subheadline */}
        <p className="mx-auto mt-6 max-w-2xl text-base text-neutral-300 sm:text-lg sm:leading-relaxed">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3">
          <a
            ...
            className="group relative inline-flex items-center justify-center gap-3 rounded-xl bg-metallic-terracotta px-9 py-4 text-base font-semibold text-white shadow-xl glow-terracotta transition-all hover:scale-102 hover:opacity-95 active:scale-98 cursor-pointer"
          >
        ...
        <div className="mt-14 mb-5 flex flex-col items-center">
          <span className="text-[11px] uppercase tracking-wider text-neutral-400 font-mono mb-3">
        ...
        <div id="exemplo-site-profissional" className="mt-4">
          <div className="mx-auto max-w-4xl rounded-2xl border border-[#262626] bg-[#0E0E0E] p-3 sm:p-5 shadow-2xl glow-terracotta-subtle">
            {/* Browser top bar */}
            <div className="flex items-center justify-between border-b border-[#1E1E1E] pb-3 mb-4">
              <div className="flex items-center gap-2">
                <span className="h-3 w-3 rounded-full bg-[#262626]" />
                <span className="h-3 w-3 rounded-full bg-[#262626]" />
                <span className="h-3 w-3 rounded-full bg-[#262626]" />
              </div>

              {/* Simulated Domain Bar */}
              <div className="flex items-center gap-2 rounded-lg bg-[#141414] px-4 py-1 text-xs text-neutral-300 font-mono border border-[#2A2A2A] max-w-xs sm:max-w-md w-full justify-center">
                <Globe className="h-3 w-3 text-[#E07A5F]" />
                <span className="text-white font-medium">{currentExample.domain}</span>
                <span className="hidden sm:inline text-[#E07A5F] text-[10px] font-sans font-semibold bg-[#221612] px-2 py-0.5 rounded border border-[#C86D51]/30">
                  SSL Seguro
                </span>
              </div>

              {/* Device Toggle */}
              <div className="flex items-center gap-1 rounded-lg bg-[#181818] p-0.5 border border-[#262626]">
                <button
                  type="button"
            ...
            <div className="overflow-hidden rounded-xl border border-[#222] bg-[#0A0A0A] text-left transition-all">
              <div className={`mx-auto transition-all duration-300 ${previewDevice === 'mobile' ? 'max-w-sm py-4' : 'w-full'}`}>
                ...
                <div className="flex items-center justify-between border-b border-[#1A1A1A] px-6 py-3 bg-[#0D0D0D]">
                  <div className="flex items-center gap-2.5">
                    <div className="h-7 w-7 rounded-lg bg-metallic-terracotta text-white flex items-center justify-center font-serif font-bold text-xs shadow-xs">
